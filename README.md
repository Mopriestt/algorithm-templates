...
- [Segment Trees](https://en.wikipedia.org/wiki/Segment_tree)
   - [bitwise-based single update max](https://github.com/Mopriestt/algorithm-templates/blob/main/data_structure/bitwise_segment_tree_single_update_max.cpp)
   - [bitwise-based single update sum](https://github.com/Mopriestt/algorithm-templates/blob/main/data_structure/bitwise_segment_tree_single_update_sum.cpp)
   - [pointer-based max & sum range update](https://github.com/Mopriestt/algorithm-templates/blob/main/data_structure/segment_tree_max_sum.cpp)
- [Disjoint Set](https://github.com/Mopriestt/algorithm-templates/blob/main/data_structure/disjoint_set.cpp)
- [Heap](https://github.com/Mopriestt/algorithm-templates/blob/main/data_structure/heap.cpp)
